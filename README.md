...
Rename all outputs in every folder with [files_folders_namechanges.sh](https://github.com/ambed0ya/Palicourea/blob/main/files_folders_namechanges.sh "files_folders_namechanges.sh script") so they can then be all moved to a new folder (MO) to be pruned (e.g. `mv -t MO */*.mm`)
